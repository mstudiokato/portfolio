...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source:
          "/:path((?!api/|_next/|projekty$|projekty/|projekty\\?|polityka-prywatnosci|design-system|keystatic|admin|brief$|brief/|prevgenerator$|prevgenerator/|galerie/|klienci/|opinie/|ikonySpec/)(?!.*\\.).+)",
