/**
 * Ikona LinkedIn (inline SVG) — lokalny pakiet lucide-react (v1.17) nie eksportuje
 * `Linkedin`, więc używamy własnego glifu. fill="currentColor" → kolor dziedziczy
 * z tekstu (umożliwia hover:text-lime).
 */
